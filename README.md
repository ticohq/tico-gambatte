...
**Gambatte** is an accurate and efficient emulator for the Nintendo Game Boy and Game Boy Color.

This fork adapts Gambatte to work with the Tico frontend and provides a standalone build for the Nintendo Switch, adding a small set of practical features while keeping the original behavior intact.

----------

## Summary

This fork focuses on making Gambatte more usable in practice without changing its core design.
